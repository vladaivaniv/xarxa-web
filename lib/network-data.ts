...
export const events = [
  ...
  // IA (14-26)
  { id: 14, title: "14", category: "hiperrealitat", image: getImagePath("/IA/16.webp") },
  { id: 15, title: "15", category: "hiperrealitat", image: getImagePath("/IA/17.webp") },
  { id: 16, title: "16", category: "hiperrealitat", image: getImagePath("/IA/18.webp") },
  { id: 17, title: "17", category: "hiperrealitat", image: getImagePath("/IA/19.webp") },
  { id: 18, title: "18", category: "hiperrealitat", image: getImagePath("/IA/20.webp") },
  { id: 19, title: "19", category: "hiperrealitat", image: getImagePath("/IA/21.webp") },
  { id: 20, title: "20", category: "hiperrealitat", image: getImagePath("/IA/22.webp") },
  { id: 21, title: "21", category: "hiperrealitat", image: getImagePath("/IA/23.webp") },
  { id: 22, title: "22", category: "hiperrealitat", image: getImagePath("/IA/24.webp") },
  { id: 23, title: "23", category: "hiperrealitat", image: getImagePath("/IA/25.webp") },
  { id: 24, title: "24", category: "hiperrealitat", image: getImagePath("/IA/26.webp") },
  { id: 25, title: "25", category: "hiperrealitat", image: getImagePath("/IA/hiperrealitat.webp") },
  // PODER (27-36)
  ...
  // CONTRAIMATGES (37-45)
  { id: 37, title: "37", category: "aturat", image: getImagePath("/CONTRAIMATGES/37.webp") },
  { id: 38, title: "38", category: "aturat", image: getImagePath("/CONTRAIMATGES/38.webp") },
  { id: 39, title: "39", category: "aturat", image: getImagePath("/CONTRAIMATGES/39.webp") },
  { id: 40, title: "40", category: "aturat", image: getImagePath("/CONTRAIMATGES/40.webp") },
  { id: 41, title: "41", category: "aturat", image: getImagePath("/CONTRAIMATGES/41.webp") },
  { id: 42, title: "42", category: "aturat", image: getImagePath("/CONTRAIMATGES/42.webp") },
  { id: 43, title: "43", category: "aturat", image: getImagePath("/CONTRAIMATGES/43.webp") },
  { id: 44, title: "44", category: "aturat", image: getImagePath("/CONTRAIMATGES/44.webp") },
